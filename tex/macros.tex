...
\newcommand{\Rone}{\ensuremath{\para~S(\threetwoone) / S(\threeohthree)}\xspace}
\newcommand{\Rtwo}{\ensuremath{\para~S(\threetwotwo) / S(\threetwoone)}\xspace}
\newcommand{\JKaKc}{\ensuremath{J_{K_a K_c}}}
\newcommand{\water}{H$_{2}$O}		%  H2O
\newcommand{\feii}{\ion{Fe}{2}}		%  FeII
\newcommand{\uchii}{UC\ion{H}{2}\xspace}
\newcommand{\UCHII}{UC\ion{H}{2}\xspace}
\newcommand{\hchii}{HC\ion{H}{2}\xspace}
\newcommand{\HCHII}{HC\ion{H}{2}\xspace}
