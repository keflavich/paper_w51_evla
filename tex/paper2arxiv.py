...
ppath='/Users/adam/work/w51/paper_w51_evla/tex'
paper_name = 'w51_evla_h2co'
...
os.system('tar --exclude Makefile -czf Ginsburg_W51_EVLA_%s_%s.tar.gz %s/ ' % (time.strftime("%m%d",time.localtime()),outtype,outdir))
