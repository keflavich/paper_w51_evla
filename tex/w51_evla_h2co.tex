...
\subsection{Constraints on the outflow from IRS 2}
...
The W51 clusters are likely to reach a high star formation efficiency,
...
In IRS 2, accretion is ongoing despite its volume being largely evacuated.
...
(Section \ref{sec:irs2outflow}).  Feedback is therefore progressing more slowly
than star formation.  The inefficiency of feedback in removing the star-forming
gas supports the \citet{Matzner2015a} argument that the most massive clumps in
the galaxy  end their formation by exhausting their parent reservoir rather
than by disrupting their parent cloud.
...
\item The W51 e1/e2 and IRS 2 protoclusters appear to be high-mass clusters
    ...
    may be responsible for halting protocluster feeding.
