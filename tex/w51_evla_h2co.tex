...
(proto)stars are bound to the overall cluster gas. 
...
$r_{cluster}=1.5$ pc.  The remaining ionized gas is bound to the system, with
...
suggest the IRS2 cluster is older than W51 e1/e2, which shows no signs
...
accretion, the W51 e20 stars are likely the oldest in the W51 Main
system.
...
final mass of the clusters will be at least $\gtrsim7\ee{3} + 5\ee{4} \eta$ \msun,
...
Myr out to 2.5 pc containing 5\ee{4} \msun of gas), supernovae are not likely
...
to unbind the whole W51 GMC in a few Myr.
