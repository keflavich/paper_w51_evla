...
gradient from blue to red from southeast to northwest.  \todo{Interpret this
gradient?}
...
{The `Lacy Jet' as seen in H77$\alpha$ contours overlaid on (a) the 14 GHz
...
has expelled or consumed a large fraction of its gas, the IRS2 cluster is older than W51
...
(MYSOs) like IRS2E
\citep{Figueredo2008a}, and the numerous \hchii regions that are likely to be
