...
$r<0.05$ pc][]{Kurtz2002a}.  About ten of these \hchii regions, which are the
...
their respective bands.  These images are used in the images in the main text
of the paper. They were used for source identification but not for photometry.
Instead, for the 13A-064 data, individual 1 GHz bands including only the
longer-baseline configuration were used for photometry.
