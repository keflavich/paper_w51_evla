...
% \subsection{Sources of illumination in the extend HII regions}
% There are many extended HII regions associated with the W51 cluster area.
% While some have obvious driving sources, the W51 Main region seems not to - 
% the hypercompact HII regions are too small and not leaky enough.
