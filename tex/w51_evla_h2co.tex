...
diffuse bright region in the center is IRS 1, marking the edge of the W51 Main
...
implied mass is 350-1600 \msun, or an equivalent \hh number density $6\ee{5} < n(\hh) <
2\ee{7}$ \percc.
...
assumption may therefore be more accurate here.  Its implied density if it is
gas-dominated
is $n(\hh)\sim2\ee7$ \percc ($M_{vir}=200$ \msun).  Such a high density is consistent with
the observed \formaldehyde emission toward e8 and the presence of hypercompact \hii regions,
which require densities $n>10^6$ \percc to explain their emission.

If we assume all 7 \hchii regions in the e1 subcluster represent OB stars
($M>8\msun$) and the IMF is populated by a standard \citet{Kroupa2001a} mass
function, the cluster should be star-dominated with a mass
$M_{cluster}=700\pm250$ \msun.  This would imply a stellar mass much greater
than the virial mass, and if we include the gas mass that is necessarily
present, the cluster has a velocity dispersion well below the virial
expectation.  Most likely, the stellar mass function in this region does not
match the IMF, and instead there is a significant dearth of low-mass stars.
...
W51e1/e2, and the new W51e20 group.  The W51 IRS 2 cluster is closer to
...
suggest the IRS 2 cluster is older than W51e1/e2. The e1/e2 protocluster shows
...
W51e1/e2 and IRS 2 in the form of molecular cores (Section
...
the timescale for complete gas evacuation in IRS 2 at the presently observed
...
\item The W51e1/e2 and IRS 2 protoclusters appear to be high-mass clusters
