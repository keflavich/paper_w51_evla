...
The d4 pair (d4e and d4w) exhibit $\sim$20-year timescale variability.  There
is a region of \hh emission coincident with their position
\citep{Froebrich2011a}.  We show this in Figure \ref{fig:d4h2}.

\Figure{figures/d4_h2_overlay_ds9.png}
{A UWISH2 \hh image with Ku-band contours of sources d4e and d4w overlaid.}
{fig:d4h2}{1}{6.5in}
