...
annotations = {'w51main_peak': [[(290.92755, 14.511689), [-3, 3], [-20, 20], 'r',{}],
               ...
               'irs2_C_low':  [[(290.91379, 14.522722), [-5, 5], [-20, 30], 'b',{}],
                               ...
                               [(290.92183,14.519886), [0, 0], [ 30, 20], 'g', {}],
                               [(290.92049, 14.518521), [0, 0], [ 30,-20], 'g', {}],
                              ],
               'peak_cluster_C_diff':[
                                      [(290.92866,14.507667), [0, 0],  [-25, 0], 'r', {'text':'e20'}],
                                      [(290.92843,14.507658), [0, 0],  [0, -15], 'r', {'text':'e21'}],
                                      [(290.92821,14.507623), [0, 0],  [7, -10], 'r', {'text':'e22'}],
                                      [(290.92866,14.508448), [0, 0],  [-22, 4], 'r', {'text':'e12'}],
                                      [(290.92944,14.509612), [0, 0],  [-22, -4],'r', {'text':'e23'}],
                                     ],
              }
